...
public class AdminFunction {
    ...
    public AdminFunction(TelegramBot bot, UserService userService, AdminKyb kyb, BotPriceService botPriceService, DynamicBotService dynamicBotService, TelegramBotsApi telegramBotsApi, BotInfoRepository botInfoRepository) {
        this.bot = bot;
    ...
    public void getBotToken(User user, String text, Integer messageId) {
        if (text.equals(backButton)) {
            ...
            if (username == null) {
                ...
                System.out.printf("Noto'g'ri token kiritildi. User ID: {%d}%n", user.getId());

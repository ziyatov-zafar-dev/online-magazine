...
public class UserOnlineMagazineFunction {
    ...
    public UserOnlineMagazineFunction(BotUserService userService, DynamicBotService bot, UserOnlineMagazineKyb kyb, CategoryService categoryService, ProductService productService, ProductVariantService productVariantService, UserOnlineMagazineMsg msg, LocationRepository locationRepository, BranchRepository branchRepository) {
